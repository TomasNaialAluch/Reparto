// Íconos SVG planos NEWLOOK — stroke="currentColor" para heredar el color del contenedor.
// Reemplazan los emojis dentro de los tabs de Gestión Semanal.
// Ver README-NEWLOOK.md (regla: nunca emojis en controles de UI).
...
export const IconMoney = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconCheque = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconChart = ({ size = 14 }) => (
  <svg {...base(size)}>
    <line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" />
  </svg>
);

export const IconClipboard = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconCreditCard = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconWarning = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconPrinter = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconUsers = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconHistory = ({ size = 14 }) => (
  <svg {...base(size)}>
    <path d="M3 3v5h5" />
...
export const IconTrophy = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconTrendDown = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconInbox = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const IconSparkles = ({ size = 14 }) => (
  <svg {...base(size)}>
    ...
    <path d="m5.6 5.6 1.4 1.4" /><path d="m17 17 1.4 1.4" /><path d="m5.6 18.4 1.4-1.4" /><path d="m17 7 1.4-1.4" />
